...
class RecursiveField(Field):
    ...
    This is taken from https://github.com/heywbj/django-rest-framework-recursive
    vendorized here for easier deployment. All copyright on this file belongs to the
    author Warren Jin <jinwarren@gmail.com>.
